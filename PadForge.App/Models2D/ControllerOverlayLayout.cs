...
public static class XboxSeriesXLayout
{
    ...
    public static readonly OverlayElement[] Overlays =
    {
        ...
        new("XBSeries_LeftBumper_Active.png", "LeftShoulder", OverlayElementType.Button, 355, 78, 249, 86),
        new("XBSeries_RightBumper_Active.png", "RightShoulder", OverlayElementType.Button, 928, 78, 250, 85),
