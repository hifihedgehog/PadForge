...
namespace PadForge.Engine
{
    ...
    public class SdlDeviceWrapper : ISdlInputDevice
    {
        ...
        private void CloseInternal()
        {
            ...
            // suppress the first equal UID from the prior connection.
            // Harmless when the app reconnect path makes a fresh
            // wrapper instead.
            _nfcPrevUid = null;
        ...
        private void ReadNfcTag(CustomInputState state)
        {
            ...
            if (armed == null || !armed())
            {
                ...
                // The array stays allocated (cleared) so the
                ...
                && !string.IsNullOrEmpty(uid))
            {
                ...
                // as the exposed button: raise only when the tag
            ...
            // inherit a stale deadline on a reused button.
