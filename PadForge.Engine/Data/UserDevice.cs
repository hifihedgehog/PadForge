...
namespace PadForge.Engine.Data
{
    ...
    public partial class UserDevice : INotifyPropertyChanged
    {
        ...
        // Gyro bias + calibration timestamp moved to PadSetting in v3.3
        // so each (device, slot) gets its own re-zero. UserDevice no
        // longer participates in gyro calibration state.
