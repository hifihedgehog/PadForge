...
public class Strings : INotifyPropertyChanged
{
    ...
    public string RemoteLink_AllowAssignments => Get("RemoteLink_AllowAssignments");
    public string RemoteLink_AssignmentPermissionDescription => Get("RemoteLink_AssignmentPermissionDescription");
    public string RemoteLink_AssignDevices => Get("RemoteLink_AssignDevices");
    public string RemoteLink_AssignmentTitle_Format => Get("RemoteLink_AssignmentTitle_Format");
    public string RemoteLink_AssignmentDescription => Get("RemoteLink_AssignmentDescription");
    public string RemoteLink_AssignmentProfile_Format => Get("RemoteLink_AssignmentProfile_Format");
    public string RemoteLink_AssignmentDenied => Get("RemoteLink_AssignmentDenied");
    public string RemoteLink_AssignmentUnavailable => Get("RemoteLink_AssignmentUnavailable");
    public string RemoteLink_AssignmentStale => Get("RemoteLink_AssignmentStale");
    public string RemoteLink_AssignmentTimeout => Get("RemoteLink_AssignmentTimeout");
    public string RemoteLink_AssignmentNoDevices => Get("RemoteLink_AssignmentNoDevices");
    public string RemoteLink_AssignmentNoSlots => Get("RemoteLink_AssignmentNoSlots");
    public string RemoteLink_AssignmentBusy => Get("RemoteLink_AssignmentBusy");
    ...
    public string RemoteLink_NatSymmetric => Get("RemoteLink_NatSymmetric");
    public string RemoteLink_NatNoPublic => Get("RemoteLink_NatNoPublic");
    ...
    public string Pad_Audio_Crossfeed_LowEasy => Get("Pad_Audio_Crossfeed_LowEasy");
    public string Pad_Audio_Crossfeed_Middle => Get("Pad_Audio_Crossfeed_Middle");
    public string Pad_Audio_Crossfeed_MiddleEasy => Get("Pad_Audio_Crossfeed_MiddleEasy");
    public string Pad_Audio_Crossfeed_Off => Get("Pad_Audio_Crossfeed_Off");
    public string Pad_Audio_Crossfeed_Tooltip => Get("Pad_Audio_Crossfeed_Tooltip");
    public string Pad_Audio_Eq => Get("Pad_Audio_Eq");
    public string Pad_Audio_EqAdd => Get("Pad_Audio_EqAdd");
    public string Pad_Audio_EqClear => Get("Pad_Audio_EqClear");
    public string Pad_Audio_EqCol_Freq => Get("Pad_Audio_EqCol_Freq");
    public string Pad_Audio_EqCol_Gain => Get("Pad_Audio_EqCol_Gain");
    ...
    public string About_Interhaptics => Get("About_Interhaptics");
    public string About_InterhapticsDesc => Get("About_InterhapticsDesc");
    public string About_ValveCad => Get("About_ValveCad");
    public string About_ValveCadDesc => Get("About_ValveCadDesc");
    public string About_MingwRuntime => Get("About_MingwRuntime");
    public string About_MingwRuntimeDesc => Get("About_MingwRuntimeDesc");
    public string About_TritonLib => Get("About_TritonLib");
    public string About_TritonLibDesc => Get("About_TritonLibDesc");
    public string About_Colore => Get("About_Colore");
    public string About_ColoreDesc => Get("About_ColoreDesc");
    public string About_LogitechLedRefs => Get("About_LogitechLedRefs");
    public string About_LogitechLedRefsDesc => Get("About_LogitechLedRefsDesc");
    public string About_Opentrack => Get("About_Opentrack");
    public string About_OpentrackDesc => Get("About_OpentrackDesc");
    public string About_LegionToolkit => Get("About_LegionToolkit");
    public string About_LegionToolkitDesc => Get("About_LegionToolkitDesc");
    public string About_InputPlumber => Get("About_InputPlumber");
    ...
    public string DeviceType_Microphone => Get("DeviceType_Microphone");
    public string Voice_AnyPhrase => Get("Voice_AnyPhrase");
    public string Voice_Title => Get("Voice_Title");
    public string Voice_ManageButton => Get("Voice_ManageButton");
    public string Voice_EnableLabel => Get("Voice_EnableLabel");
    public string Voice_EnableTooltip => Get("Voice_EnableTooltip");
    public string Voice_ModeLabel => Get("Voice_ModeLabel");
    public string Voice_ModeTooltip => Get("Voice_ModeTooltip");
    public string Voice_ModeAlways => Get("Voice_ModeAlways");
    public string Voice_ModePushToTalk => Get("Voice_ModePushToTalk");
    public string Voice_ConfidenceLabel => Get("Voice_ConfidenceLabel");
    public string Voice_ConfidenceTooltip => Get("Voice_ConfidenceTooltip");
    public string Voice_ListeningIdle => Get("Voice_ListeningIdle");
    public string Voice_HeardFired_Format => Get("Voice_HeardFired_Format");
    public string Voice_HeardIgnored_Format => Get("Voice_HeardIgnored_Format");
    public string Voice_PhraseLabel => Get("Voice_PhraseLabel");
    public string Voice_NameLabel => Get("Voice_NameLabel");
    public string Voice_RegisterButton => Get("Voice_RegisterButton");
    public string Voice_RegisteredHeader => Get("Voice_RegisteredHeader");
    public string Voice_Registered_Format => Get("Voice_Registered_Format");
    ...
    public string Pad_Mapping_Scope_Tooltip => Get("Pad_Mapping_Scope_Tooltip");
    ...
    public string Menu_Reset_Cell => Get("Menu_Reset_Cell");
    public string Menu_Reset_Cells => Get("Menu_Reset_Cells");
    public string Menu_Reset_Click => Get("Menu_Reset_Click");
    public string Menu_Reset_CustomX => Get("Menu_Reset_CustomX");
    public string Menu_Reset_CustomY => Get("Menu_Reset_CustomY");
    public string Menu_Reset_Deadzone => Get("Menu_Reset_Deadzone");
    public string Menu_Reset_FireMode => Get("Menu_Reset_FireMode");
    public string Menu_Reset_Geometry => Get("Menu_Reset_Geometry");
    ...
    public string Common_Reset_Acceleration => Get("Common_Reset_Acceleration");
    public string Common_Reset_DeadZone => Get("Common_Reset_DeadZone");
    public string Common_Reset_Sensitivity => Get("Common_Reset_Sensitivity");
    public string Macro_Reset_HoldTime => Get("Macro_Reset_HoldTime");
    public string Macro_Reset_InsetX => Get("Macro_Reset_InsetX");
    public string Macro_Reset_InsetY => Get("Macro_Reset_InsetY");
    public string Macro_Reset_Interval => Get("Macro_Reset_Interval");
    public string Macro_Reset_PressWindow => Get("Macro_Reset_PressWindow");
    public string Macro_Reset_RampEnd => Get("Macro_Reset_RampEnd");
    ...
    public string MacroAction_HeadphoneVolumeDown_Tooltip => Get("MacroAction_HeadphoneVolumeDown_Tooltip");
    ...
    public string MacroAction_Type_VoiceListenWhileHeld => Get("MacroAction_Type_VoiceListenWhileHeld");
    public string MacroAction_VoiceListenWhileHeld_Tooltip => Get("MacroAction_VoiceListenWhileHeld_Tooltip");
    ...
    public string Menu_Binding_Macro => Get("Menu_Binding_Macro");
    ...
    public string Pad_Menus_IconPackages_Add_Tooltip => Get("Pad_Menus_IconPackages_Add_Tooltip");
    public string Pad_Menus_IconPackages_Create => Get("Pad_Menus_IconPackages_Create");
    public string Pad_Menus_IconPackages_Create_Tooltip => Get("Pad_Menus_IconPackages_Create_Tooltip");
    public string Pad_Menus_IconPackages_Remove_Tooltip => Get("Pad_Menus_IconPackages_Remove_Tooltip");
    public string Pad_Menus_IconPackages_Empty => Get("Pad_Menus_IconPackages_Empty");
    public string Pad_Menus_IconPackages_PickImages => Get("Pad_Menus_IconPackages_PickImages");
    ...
    public string Settings_GyroInvertRoll => Get("Settings_GyroInvertRoll");
    public string Settings_GyroInvertRoll_Tooltip => Get("Settings_GyroInvertRoll_Tooltip");
    ...
    public string Pad_ResetGyroInvertRoll => Get("Pad_ResetGyroInvertRoll");
    ...
    public string Pad_Touchpad_MomentumFlingGain => Get("Pad_Touchpad_MomentumFlingGain");
    public string Pad_Touchpad_MomentumFlingGain_Tooltip => Get("Pad_Touchpad_MomentumFlingGain_Tooltip");
    public string Pad_ResetTouchpadMomentumFlingGain => Get("Pad_ResetTouchpadMomentumFlingGain");
    public string Pad_Touchpad_MomentumMinLift => Get("Pad_Touchpad_MomentumMinLift");
    public string Pad_Touchpad_MomentumMinLift_Tooltip => Get("Pad_Touchpad_MomentumMinLift_Tooltip");
    public string Pad_ResetTouchpadMomentumMinLift => Get("Pad_ResetTouchpadMomentumMinLift");
    public string Pad_Touchpad_MomentumMaxSpeed => Get("Pad_Touchpad_MomentumMaxSpeed");
    public string Pad_Touchpad_MomentumMaxSpeed_Tooltip => Get("Pad_Touchpad_MomentumMaxSpeed_Tooltip");
    public string Pad_ResetTouchpadMomentumMaxSpeed => Get("Pad_ResetTouchpadMomentumMaxSpeed");
    public string Pad_Touchpad_MomentumStacking => Get("Pad_Touchpad_MomentumStacking");
    public string Pad_Touchpad_MomentumStacking_Tooltip => Get("Pad_Touchpad_MomentumStacking_Tooltip");
    public string Pad_ResetTouchpadMomentumStacking => Get("Pad_ResetTouchpadMomentumStacking");
    ...
    public string HeadTracker_X => Get("HeadTracker_X");
    public string HeadTracker_Y => Get("HeadTracker_Y");
    public string HeadTracker_Z => Get("HeadTracker_Z");
    public string Dashboard_HeadTracking => Get("Dashboard_HeadTracking");
    public string Dashboard_HeadTrackingDesc => Get("Dashboard_HeadTrackingDesc");
    ...
    public string Dashboard_HeadTrackingRotationRange_Tooltip => Get("Dashboard_HeadTrackingRotationRange_Tooltip");
    public string Dashboard_HeadTrackingTranslationRange => Get("Dashboard_HeadTrackingTranslationRange");
    public string Dashboard_HeadTrackingTranslationRange_Tooltip => Get("Dashboard_HeadTrackingTranslationRange_Tooltip");
    public string HeadTracker_StatusWaiting_Format => Get("HeadTracker_StatusWaiting_Format");
    public string HeadTracker_StatusUdp_Format => Get("HeadTracker_StatusUdp_Format");
    ...
    public string Handheld_Intro => Get("Handheld_Intro");
    public string Handheld_MachineLabel => Get("Handheld_MachineLabel");
    public string Handheld_StartButton => Get("Handheld_StartButton");
    public string Handheld_PhaseIdle => Get("Handheld_PhaseIdle");
    ...
    public string Handheld_RegisterButton => Get("Handheld_RegisterButton");
    public string Handheld_RegisteredHeader => Get("Handheld_RegisteredHeader");
    public string Handheld_NoneLearned => Get("Handheld_NoneLearned");
    public string Handheld_RegisteredFormat => Get("Handheld_RegisteredFormat");
    ...
    public string Handheld_ImportedFormat => Get("Handheld_ImportedFormat");
    public string Settings_Handheld => Get("Settings_Handheld");
    public string Settings_HandheldDesc => Get("Settings_HandheldDesc");
    public string Settings_HandheldEnable => Get("Settings_HandheldEnable");
    public string Settings_HandheldEnable_Tooltip => Get("Settings_HandheldEnable_Tooltip");
    ...
    public string Menu_Layer => Get("Menu_Layer");
    public string Menu_Layer_Tip => Get("Menu_Layer_Tip");
    public string Menu_Reset_Layer => Get("Menu_Reset_Layer");
    public string Menu_Layer_Missing_Format => Get("Menu_Layer_Missing_Format");
    public string Menu_LayerHoldsOpen => Get("Menu_LayerHoldsOpen");
    public string Menu_LayerHoldsOpen_Tip => Get("Menu_LayerHoldsOpen_Tip");
    public string Menu_Reset_LayerHoldsOpen => Get("Menu_Reset_LayerHoldsOpen");
    public string Menu_Host_SteerWith => Get("Menu_Host_SteerWith");
    public string Menu_Host_SteerWith_Tip => Get("Menu_Host_SteerWith_Tip");
    public string Menu_Host_SteerWith_Caption => Get("Menu_Host_SteerWith_Caption");
    public string Menu_IconScale => Get("Menu_IconScale");
    public string Menu_IconScale_Tip => Get("Menu_IconScale_Tip");
    public string Menu_Fire_Click_LayerHold_Desc => Get("Menu_Fire_Click_LayerHold_Desc");
    public string Menu_Fire_ClickRelease_LayerHold_Desc => Get("Menu_Fire_ClickRelease_LayerHold_Desc");
    public string Menu_Fire_TouchRelease_LayerHold_Desc => Get("Menu_Fire_TouchRelease_LayerHold_Desc");
    public string Menu_Fire_Always_LayerHold_Desc => Get("Menu_Fire_Always_LayerHold_Desc");
    public string Menu_Fire_ButtonPairGrid_Desc => Get("Menu_Fire_ButtonPairGrid_Desc");
    ...
    public string Pad_Output_Subtitle => Get("Pad_Output_Subtitle");
    ...
    public string ResetLabel_HighColor => Get("ResetLabel_HighColor");
