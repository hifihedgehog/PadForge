...
namespace PadForge.SteamWorkshop.Tests
{
    ...
    ///
    /// <para>Audit 2026-07-14: executing the translator on
    /// this exact shape returned XboxRows=0. The rescue retargets such a
    ...
    public class MacroTriggerReachabilityTests
    {
        ...
        {
            // Regression case: A carries key_press W
