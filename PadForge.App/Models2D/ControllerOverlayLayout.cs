...
public static class Xbox360Layout
{
    ...
    public static readonly OverlayElement[] Overlays =
    {
        ...
        new("XB360_LeftTrigger_Active.png", "LeftTrigger", OverlayElementType.Trigger, 273, 26, 143, 107),
        new("XB360_RightTrigger_Active.png", "RightTrigger", OverlayElementType.Trigger, 1160, 26, 143, 104),
...
public static class XboxOneSLayout
{
    ...
    public static readonly OverlayElement[] Overlays =
    {
        ...
        new("XB1_LeftBumper_Active.png", "LeftShoulder", OverlayElementType.Button, 180, 123, 339, 131),
        new("XB1_RightBumper_Active.png", "RightShoulder", OverlayElementType.Button, 1024, 123, 339, 130),
