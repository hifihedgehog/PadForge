...
- **Flight-sim-grade input precision** — 1000 Hz polling with sub-millisecond jitter, bit-perfect axis passthrough at default settings, double-precision dead zone math, and 16-bit (65536-position) vJoy axis output that exceeds the resolution of physical controller ADCs
