...
public class Strings : INotifyPropertyChanged
{
    ...
    public string Pad_ForceFeeedback => Get("Pad_ForceFeeedback");
    ...
    public string Btn_LeftBumper => Get("Btn_LeftBumper");
    public string Btn_RightBumper => Get("Btn_RightBumper");
    public string Btn_Back => Get("Btn_Back");
    public string Btn_Start => Get("Btn_Start");
    public string Btn_Guide => Get("Btn_Guide");
    public string Btn_LeftStickClick => Get("Btn_LeftStickClick");
    public string Btn_RightStickClick => Get("Btn_RightStickClick");
