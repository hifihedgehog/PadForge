...
| [MinGW-w64 runtime](https://www.mingw-w64.org/) | `libgcc_s_seh-1.dll`, `libstdc++-6.dll` and `libwinpthread-1.dll`, the native runtime the Vosk recognizer needs, shipped inside the executable | GPL-3.0 with the GCC Runtime Library Exception, mingw-w64 winpthreads |
